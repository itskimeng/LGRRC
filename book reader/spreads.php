<?php 
include '../admin/function php/conn.php';

$bookId = $_GET['id'];
$sql = " SELECT `imageName` FROM `tbl_books` WHERE `id` = '$bookId' ";
$exec = $conn->query($sql);
...
<body>
  ...
  <script>
    ...
    var book = ePub(url || '<?php echo '../books/'.$fileName; ?>');
    // var book = ePub(url || "pdf1.pdf");
